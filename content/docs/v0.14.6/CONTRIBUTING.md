...
url: /docs/v0.14.6/welcome/contributing/
aliases:
- /docs/v0.14.6/CONTRIBUTING/
info:
  version: v0.14.6
---
...
We have a [Developer Guide](/docs/v0.14.6/setup/developer-guide/overview) that outlines everything you need to know from setting up your
