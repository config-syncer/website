...
* [config-syncer run](/docs/v0.14.6/reference/config-syncer_run)	 - Launch Kubernetes Cluster Daemon
* [config-syncer version](/docs/v0.14.6/reference/config-syncer_version)	 - Prints binary version number.
