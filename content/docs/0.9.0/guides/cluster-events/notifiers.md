...
![telegram-bot](/docs/0.9.0/images/event-forwarder/telegram-bot.png)
...
## Next Steps
 - Want to keep an eye on your cluster with automated notifications? Setup Kubed [event forwarder](/docs/0.9.0/guides/cluster-events/event-forwarder).
