...
![origin annotation](/docs/0.9.0/images/config-syncer/config-origin.png)
...
## Next Steps
 - Learn how to sync config-maps or secrets across multiple cluster [here](/docs/0.9.0/guides/config-syncer/inter-cluster).
