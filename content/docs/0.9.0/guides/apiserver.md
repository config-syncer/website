...
Now, deploy Kubed in your cluster following the steps [here](/docs/0.9.0/setup/install). Once the operator pod is running, go to the next section.
...
## Cleaning up
To cleanup the Kubernetes resources created by this tutorial, uninstall Kubed following the steps [here](/docs/0.9.0/setup/uninstall).
