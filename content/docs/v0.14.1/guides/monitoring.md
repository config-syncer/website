...
![operator-metrics](/docs/v0.14.1/images/monitoring/operator-metrics.png)
...
## Next Steps
 - Need to keep configmaps/secrets synchronized across namespaces or clusters? Try [Config Syncer config syncer](/docs/v0.14.1/guides/config-syncer/).
