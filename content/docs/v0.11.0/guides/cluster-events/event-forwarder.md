...
Now, deploy Kubed operator in your cluster following the steps [here](/docs/v0.11.0/setup/install). Once the operator pod is running, go to the next section.
...
![PVC Added Notification](/docs/v0.11.0/images/event-forwarder/pvc-added-notification.png)
...
![Pod Failed](/docs/v0.11.0/images/event-forwarder/pod-fail-1.png)
![Pod FailedSync](/docs/v0.11.0/images/event-forwarder/pod-fail-2.png)
...
To uninstall Kubed operator, please follow the steps [here](/docs/v0.11.0/setup/uninstall).


## Next Steps
 - See the list of supported notifiers [here](/docs/v0.11.0/guides/cluster-events/notifiers).
