...
url: /docs/0.5.0/welcome/changelog/
aliases:
- /docs/0.5.0/CHANGELOG/
info:
  version: 0.5.0
---
...
__Notable Features__
 ...
 - Send [push notification](/docs/0.5.0/tutorials/notifiers#pushovernet) via [pushover.net](https://pushover.net/) Thanks [Sean Johnson](https://github.com/pirogoeth) !
...
__Notable Features__
 ...
 - Takes periodic [snapshot](/docs/0.5.0/tutorials/cluster-snapshot) of a Kubernetes cluster objects.
 - Provides a [recycle bin](/docs/0.5.0/tutorials/recycle-bin) for deleted and/or updated Kubernetes objects.
 - Keep [ConfigMaps and Secrets synchronized across Namespaces](/docs/0.5.0/tutorials/config-syncer).
 - [Forward cluster events](/docs/0.5.0/tutorials/event-forwarder) to various destinations.
 - Setup [janitors](/docs/0.5.0/tutorials/janitors) for Elasticsearch and InfluxDB.
 - [Send notifications](/docs/0.5.0/tutorials/notifiers) via Email, SMS or Chat.
 - Includes a built-in [search engine](/docs/0.5.0/tutorials/apiserver) for your cluster objects using [bleve](https://github.com/blevesearch/bleve).
