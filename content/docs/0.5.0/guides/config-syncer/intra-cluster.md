...
## Origin Annotation
Since 0.5.0, Kubed operator will apply `kubed.appscode.com/origin` annotation on ConfigMap or Secret copies.

![origin annotation](/docs/0.5.0/images/config-syncer/config-origin.png)
...
## Next Steps
 - Learn how to sync config-maps or secrets across multiple cluster [here](/docs/0.5.0/guides/config-syncer/inter-cluster).
