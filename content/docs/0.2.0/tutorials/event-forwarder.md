...
| `eventForwarder.receiver`                 | `Required`. To learn how to use various notifiers, please visit [here](/docs/0.2.0/tutorials/notifiers). |
...
Now, deploy Kubed operator in your cluster following the steps [here](/docs/0.2.0/install). Once the operator pod is running, go to the next section.
...
![PVC Added Notification](/docs/0.2.0/images/event-forwarder/pvc-added-notification.png)
...
![Pod Failed](/docs/0.2.0/images/event-forwarder/pod-fail-1.png)
![Pod FailedSync](/docs/0.2.0/images/event-forwarder/pod-fail-2.png)
...
To uninstall Kubed operator, please follow the steps [here](/docs/0.2.0/uninstall).
