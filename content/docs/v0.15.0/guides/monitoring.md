...
![operator-metrics](/docs/v0.15.0/images/monitoring/operator-metrics.png)
...
## Next Steps
 - Need to keep configmaps/secrets synchronized across namespaces or clusters? Try [Config Syncer config syncer](/docs/v0.15.0/guides/config-syncer/).
