...
![origin annotation](/docs/v0.15.0/images/config-syncer/config-origin.png)
...
To uninstall Config Syncer operator, please follow the steps [here](/docs/v0.15.0/setup/uninstall).

## Next Steps

- Learn how to sync config-maps or secrets across multiple cluster [here](/docs/v0.15.0/guides/config-syncer/inter-cluster).
