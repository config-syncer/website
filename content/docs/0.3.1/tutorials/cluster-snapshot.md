...
Now, deploy Kubed operator in your cluster following the steps [here](/docs/0.3.1/install). Once the operator pod is running, check your bucket from Google Cloud console. You should see the data from initial snapshot operation.

![GCS Snapshot](/docs/0.3.1/images/cluster-snapshot/gcs-snapshot.png)
...
Now, deploy Kubed operator in your cluster following the steps [here](/docs/0.3.1/install). Once the operator pod is running, check your bucket from S3 console. You should see the data from initial snapshot operation.
...
Now, deploy Kubed operator in your cluster following the steps [here](/docs/0.3.1/install). Once the operator pod is running, check your container from Azure portal. You should see the data from initial snapshot operation.
...
Now, deploy Kubed operator in your cluster following the steps [here](/docs/0.3.1/install). Once the operator pod is running, check your container. You should see the data from initial snapshot operation.
...
Now, deploy Kubed operator in your cluster. Since, `snapshotter.local.path` is set to `/var/data`, mount your local volume at that path. You can find example installation scripts below:
 - [Without RBAC](/docs/0.3.1/examples/cluster-snapshot/local/without-rbac.yaml)
 - [With RBAC](/docs/0.3.1/examples/cluster-snapshot/local/with-rbac.yaml)
