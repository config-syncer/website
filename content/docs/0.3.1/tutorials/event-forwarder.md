...
| `eventForwarder.receiver`                 | `Required`. To learn how to use various notifiers, please visit [here](/docs/0.3.1/tutorials/notifiers). |
...
![PVC Added Notification](/docs/0.3.1/images/event-forwarder/pvc-added-notification.png)
...
![Pod Failed](/docs/0.3.1/images/event-forwarder/pod-fail-1.png)
![Pod FailedSync](/docs/0.3.1/images/event-forwarder/pod-fail-2.png)
...
To uninstall Kubed operator, please follow the steps [here](/docs/0.3.1/uninstall).
