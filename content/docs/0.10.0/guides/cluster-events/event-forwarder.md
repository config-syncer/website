...
![PVC Added Notification](/docs/0.10.0/images/event-forwarder/pvc-added-notification.png)
...
![Pod Failed](/docs/0.10.0/images/event-forwarder/pod-fail-1.png)
![Pod FailedSync](/docs/0.10.0/images/event-forwarder/pod-fail-2.png)
...
## Next Steps
 - See the list of supported notifiers [here](/docs/0.10.0/guides/cluster-events/notifiers).
