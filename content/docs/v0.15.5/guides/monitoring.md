...
![operator-metrics](/docs/v0.15.5/images/monitoring/operator-metrics.png)
...
## Next Steps
 - Need to keep configmaps/secrets synchronized across namespaces or clusters? Try [Config Syncer config syncer](/docs/v0.15.5/guides/config-syncer/).
