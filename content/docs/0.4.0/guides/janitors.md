...
Now, deploy Kubed operator in your cluster following the steps [here](/docs/0.4.0/setup/install). Once the operator pod is running, janitor operations are applied within one hour.
