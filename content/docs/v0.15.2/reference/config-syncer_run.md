---
title: Config-Syncer Run
menu:
  docs_v0.15.2:
    identifier: config-syncer-run
    name: Config-Syncer Run
    parent: reference
product_name: kubed
...
* [config-syncer](/docs/v0.15.2/reference/config-syncer)	 - Config Syncer by AppsCode - A Kubernetes Configuration Syncer
